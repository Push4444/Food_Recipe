...
<body class="bg-blue-50 overflow-x-hidden">
		...
		<div class="flex pt-5 md:pt-12 justify-center">
			<div class="bg-white md:h-96 w-11/12 md:w-7/10 md:mx-8 md:flex md:max-w-5xl shadow-lg rounded-lg">
				<div class="md:w-1/2 h-64% rounded-t-lg md:rounded-t-none md:rounded-tl-lg md:rounded-bl-lg md:h-auto overflow-hidden"><br>
					<img id="dish-page-image" class="object-cover" src="Pesarattu1.jpg" />
				...
				<div class="mb-4 pt-5 px-6 max-w-xl md:max-w-5xl md:w-1/2" style="overflow: scroll">
					<h2 id="dish-page-name" class="text-3xl font-medium text-yellow-600">Pesarattu</h2>
					...
					<p id="dish-page-ingredients" class="mt-4 text-gray-600 text-base font-regular">
						<span><li class="text-base font-regular">1 cup green moong dal</li></span>
						<span><li>2 tbsp raw rice</li></span>
						<span><li>1 tsp cumin seeds</li></span>
						<span><li>Chopped onions</li></span>
						<span><li>Chopped Green chillies</li></span>
						<span><li>Salt to taste</li></span>
						<span><li>1 inch Ginger piece</li></span>
						<span><li>Water as reqired</li></span> 
					</p>
				...
				<div class="pt-5 px-6 max-w-xl lg:max-w-5xl mb-4">
					...
					<span id="dish-page-video-present" class="hidden bg-green-400 text-gray-50 text-sm font-light rounded-md px-2 py-1">Video</span>
					 <p id="dish-page-direction-text" class="mt-4 font-regular text-base">
                        <b>Pesarattu Mix</b>
                        <br><br>
                        <span><li>To a mixing bowl add 1 cup green moong dal and 2 tbsp raw rice. Pick any stones and discard if any.<br></li></span>
                        <span><li>Soak in water for 6-8 hours. Set aside and keep it covered.<br></li></span>
                        <span><li>Rinse well atleast for 2 times.<br>
                        <span><li>Now add it mixer along with 1 tsp cumin seeds, 2 nos green chillies and 1 inch ginger, required salt. Add little water needed to grind it to a thick batter.<br>
                        <span><li>Grind it a smooth batter like idli dosa batter consistency.</li></span>
						<span><li>Transfer this to a mixing bowl. Rinse the mixer with little water and add it.</li></span>
                        <span><li>Adjust water and make batter pourable.</li></span>
                        <span><li>Heat dosa tawa – sprinkle water to check. If there is a sharp shh sound then the tawa is ready.</li></span>
                        <span><li>Pour 2 small laddles of dosa batter and spread it in concentric circles as shown. Sprinkle 2 tbsp raw onion(optional), drizzle oil..</li></sapn>
                        <span><li>Slightly press the onion so that it gets stuck to the batter. Cook until it turns golden.</li></span>
                        <span><li>Now flip over, fold and serve. You can make thick soft dosas too.</li></span>
                        <span><li>Pesarattu is ready to be served.</li></span>        
                    </p>
                    <br>
	<!-- video section -->
                <center>
					<iframe width="700" height="400" src="https://www.youtube.com/embed/MG9xyybkBK8" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                </center>   
				...
				<div class="wrapper">
					<form action="" method="post" class="form">
						...
						<br>
						<textarea name="message"  class="message" placeholder="type your comment"  style="border:solid 1px orange ; height:100%;width:100%;"></textarea>
						<br>
	...
	<div><?php include ('pesarattubackend.php');?></div>
    ...
    <footer>
        <div class="footer_main">
            ...
            <div class="footer_tag">
                ...
                <a href="https://twitter.com/i/flow/login"><i class="fa-brands fa-twitter"></i></a><br><br>
